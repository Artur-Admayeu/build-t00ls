job('MNTLAB-aadmayeu-main-build-job') {
  ...
  parameters {
    ...
    activeChoiceReactiveParam('Job_name') {
           ...
           choiceType('CHECKBOX')
           groovyScript {
               script('return ["MNTLAB-aadmayeu-child1-build-job", "MNTLAB-aadmayeu-child2-build-job", "MNTLAB-aadmayeu-child3-build-job", "MNTLAB-aadmayeu-child4-build-job"]')
           }
    }
  }
  ...
  scm {
    git {
      remote {
        url 'https://github.com/Artur-Admayeu/build-t00ls'
      }
      branch '$BRANCH_NAME'
    }
  }
...
def JOBS = ["MNTLAB-aadmayeu-child1-build-job", "MNTLAB-aadmayeu-child2-build-job", "MNTLAB-aadmayeu-child3-build-job", "MNTLAB-aadmayeu-child4-build-job"]
for(job in JOBS) {
